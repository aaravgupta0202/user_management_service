                                    ...
                                    <tr>
                                        <td style="padding:0 0 30px 0;color:#153643;">
                                            ...
                                            <p style="margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;">
                                                Your OTP is: <b><i>{{otp}}</i></b>. This is a sample email template. You can use this structure for various purposes like newsletters, notifications, or transactional emails.
